	    ...
	    <div style="padding: 0px 30px 0px 30px;">
	      <div style="margin-top:10px">
	        <div style="display:flex; justify-content: space-between;">
	          <h2 style="text-align: left; display: inline; cursor: pointer;" align="left"><?php echo $prog_id; ?></h2>
      ...
      <hr style="margin-top: 0px; margin-bottom: 20px;">
	      <?php
	          ...
	          while($p = mysqli_fetch_array($lab)){
	            ...
	            ?>
	            <a class = 'area'
	            href="parameters.php?prog_id=<?php echo $prog_id;?>&col_id=<?php echo $col_id;?>&area_id=<?php echo $acode;?>">
