...
<body  onload="myFunctions()">
	<?php
	    require 'nav.php';
	    $query="SELECT * FROM area_parameter WHERE Param_ID = '$param_id'";
	    ...
	    <div style="padding: 0px 30px 0px 30px;">
	      <div style="margin-top:10px">
	        <div style="display:flex; justify-content: space-between;">
	          <h2 style="text-align: left; display: inline; cursor: pointer;" align="left"> Parameter <?php echo $paramcode.' - <i style="font-weight: normal; font-size: 20px">'. $param_desc .'</i>'; ?> </h2>
	          <button style="float: right; display: inline; margin-right: 10px; margin-top: 15px; width: 28%" class="add_college" id="myBtn"><i class="fa-solid fa-plus"></i> &nbsp;Add Benchmark / Subbenchmark</button>
	        </div>
	      <hr style="margin-top: 0px;">
	      <div class="breadcrumbs">
	      	<a href="colleges.php"><?php echo $col_id; ?></a> 
	      	...
	      	&emsp;<i class="fa-solid fa-angle-right" style="font-size: 12pt" disabled></i> 
	      	&emsp;<a href="parameters.php?prog_id=<?php echo $prog_id;?>&col_id=<?php echo $col_id;?>&area_id=<?php echo $area_id;?>"><?php echo $_SESSION['Area']; ?></a>
	      	&emsp;<i class="fa-solid fa-angle-right" style="font-size: 12pt" disabled></i>
	      	&emsp;<a href="parameters.php?prog_id=<?php echo $prog_id;?>&col_id=<?php echo $col_id;?>&area_id=<?php echo $area_id;?>&param_id=<?php echo $param_id;?>">Parameter <?php echo $paramcode; ?></a>
	      </div>
      <hr style="margin-top: 0px; margin-bottom: 20px;">
	      <?php
	          $codes = "<span id='code'></span>";
	          $query = "SELECT * FROM area_benchmark WHERE Param_ID = '$param_id'";
	          $lab = mysqli_query($link, $query);
	          $blng = 1;
	          while($p = mysqli_fetch_array($lab)){
	            $benchcode = $p['BenchID']; ?>
	            <a class = 'area' href="parameters.php?prog_id=<?php echo $pcode;?>&col_id=<?php echo $col_id;?>&area_id=<?php echo $area_id;?> &param_id=<?php echo $paramcode;?>">
