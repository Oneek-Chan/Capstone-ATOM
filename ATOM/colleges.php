    ...
    <div style="padding: 0px 30px 0px 30px;">
      ...
      <?php 
        ...
        while($r = mysqli_fetch_array($res)){
          $ccode = $r['CollegeCode'];
        ?>
        <a class = 'folder-clg' href='programs.php?col_id=<?php echo $ccode;?>'><i class='fa-solid fa-folder-open' ></i> <div style="margin-left: 10px; background-color: lightgrey; width: 1.5px; height: 100%; display: inline-block; margin-bottom: -5px; margin-right: 5px;" ></div> &nbsp;<?php echo $ccode;?></a>
        <?php
          $n1++;
        }
       ?>
