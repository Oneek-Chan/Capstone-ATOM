      ...
      <!-- Modal content -->
        ...
        if (isset($_POST['upload']))
        {
     	...
     	<div class="file-container">
	      <div ng-repeat="document in document" class="file" id="link-1" style="padding: 10px 10px 35px 10px;">
	     	 		<br>
	     	 		<div class="file-pdf"><img src="img/PDF.png" class="file-pic"></div><br><span class="file-name">{{document.name}}</span>
...
<script type="text/javascript">
	...
	document.oncontextmenu = function(e) {
	  var elmnt = e.target
	  if (elmnt.className.startsWith("file")) {
	    e.preventDefault();
